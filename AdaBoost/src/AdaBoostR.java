/** 
 * AdaBoostR.java
 * An implementation of AdaBoostR for regression. Based on the algorithm in 
...
public class AdaBoostR {
	...
	public AdaBoostR(ArrayList<TrainingExample> train_set) {
		...
		System.out.println("AdaboostR initialized.");
	 ...
	 */
	private double goldenSectionSearch(double a, double b, double c, 
			double cost_b, WeakLearner wlt) {
		double phi = (1.0 + Math.sqrt(5)) / 2.0;
	...
	public static void main(String[] args) {
		// Get training set
		DataParser.processFile("data/SEASON-2010.csv", false);
